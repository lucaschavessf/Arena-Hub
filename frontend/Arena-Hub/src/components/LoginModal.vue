        ...
        >
          ...
          <div v-else class="modal-content">
            ...
            <div v-if="!recoverSent" class="modal-form">
              <div class="input-group" :class="{ 'input-group--error': recoverError }">
                ...
                <input
                  ...
                  @input="recoverError = ''"
                />
                <span v-if="recoverError" class="error-message" role="alert">{{
                  recoverError
                }}</span>
              </div>
              ...
              <button class="btn-back-link" @click="recoverMode = false" :disabled="isLoading">
                ← Voltar para o login
              </button>
            </div>
            ...
            <div v-else class="success-state">
              ...
              <p>
                Instruções enviadas para <strong>{{ recoverEmail }}</strong>
              </p>
