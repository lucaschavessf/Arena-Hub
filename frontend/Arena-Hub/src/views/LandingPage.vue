    ...
    <main class="main-content">
      <section class="hero-section">
        ...
        <div class="hero-container">
          <div class="hero-text-content">
            ...
            <p class="hero-subtitle">
              Sua porta de entrada para os maiores espetáculos de Pernambuco. Shows históricos,
              clássicos do futebol e experiências únicas.
            </p>
        ...
        <div class="hero-wave">
          ...
          >
            <path
              d="M0 120L60 105C120 90 240 60 360 50C480 40 600 50 720 55C840 60 960 60 1080 50C1200 40 1320 20 1380 10L1440 0V120H1380C1320 120 1200 120 1080 120C960 120 840 120 720 120C600 120 480 120 360 120C240 120 120 120 60 120H0V120Z"
              fill="#0a0e17"
            />
          </svg>
        </div>
